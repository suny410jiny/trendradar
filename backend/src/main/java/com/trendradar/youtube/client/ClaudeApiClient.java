...
public class ClaudeApiClient {
    ...
    /**
     * 모델과 maxTokens를 지정하여 Claude API 호출
     */
    public String generate(String prompt, String model, int maxTokens) {
        ...
        try {
            ...
            return "분석 생성에 실패했습니다.";
        } catch (Exception e) {
            log.error("Claude API call failed with model={}", model, e);
            throw new RuntimeException("AI 분석 생성 중 오류가 발생했습니다.", e);
        }
    }
